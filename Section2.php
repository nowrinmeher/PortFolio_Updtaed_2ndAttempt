<?php
session_start(); // Start the session to store data across sections

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Store Section B data in session for future use
    $_SESSION['soft_skills'] = $_POST['soft_skills'];
    $_SESSION['technical_skills'] = $_POST['technical_skills'];

    // Redirect to Section C (Academic Background)
...
<h3>Section B: Skills</h3>

<!-- Form to handle Section B data -->
<form action="Section2.php" method="POST" enctype="multipart/form-data" class="form-container">
    <label for="soft_skills">Soft Skills</label>
    <textarea name="soft_skills" required placeholder="List your soft skills..."></textarea>

    <label for="technical_skills">Technical Skills</label>
    <textarea name="technical_skills" required placeholder="List your technical skills..."></textarea>
