...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Store Section C data in session for future use
    $_SESSION['institute'] = $_POST['institute'];
    $_SESSION['degree'] = $_POST['degree'];
    $_SESSION['year'] = $_POST['year'];
    $_SESSION['grade'] = $_POST['grade'];

    // Redirect to Section D (Work Experience)
...
<h3>Section C: Academic Background</h3>

<!-- Form to handle academic background -->
<form action="Section3.php" method="POST" enctype="multipart/form-data" class="form-container">
    <label for="institute">Institute</label>
    <input type="text" name="institute" placeholder="Institute name (optional)">

    <label for="degree">Degree</label>
    <input type="text" name="degree" placeholder="Degree (optional)">

    <label for="year">Year of Graduation</label>
    <input type="text" name="year" placeholder="Graduation Year">

    <label for="grade">Grade/CGPA</label>
    <input type="text" name="grade" placeholder="Grade or CGPA (optional)">
